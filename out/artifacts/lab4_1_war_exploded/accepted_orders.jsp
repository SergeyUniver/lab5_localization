...
<%@ page import="actions.ShowAcceptedOrdersAction" %>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="TestServlet?action=SHOW_ACCEPTED_ORDERS"><fmt:message key="index.accepted_orders" /></a></li>
...
<div class="container">
    ...
    <div class="starter-template">
        ...
        <form id="bootstrapSelectForm" method="post" class="form-horizontal">
            <div class="container">
                <h2><fmt:message key="index.accepted_orders" /></h2>
                <table class="table table-bordered">
                    <thead>
                    <tr>
                        <th><fmt:message key="accepted_orders.id" /></th>
                        <th><fmt:message key="accepted_orders.dish" /></th>
                        <th><fmt:message key="accepted_orders.count" /></th>
                    </tr>
                    </thead>
                    <tbody>
                    <%
                        Vector<Order> orders = (Vector<Order>) session.getAttribute(ShowAcceptedOrdersAction.ORDER_PARAM);
